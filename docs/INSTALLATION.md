...
Click it and then select the encapsuled python from the following folder `C:\pytia\pytia-title-block\.env\Scripts\python.exe`. Keep in mind that your pytia-folder may be located somewhere else.
